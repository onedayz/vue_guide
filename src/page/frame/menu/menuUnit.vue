...
.menu-name__depth{
    &-2{padding-left:$_unit-padding*4; background-color: $color__teal-700; font-size: 14px;}
    &-3{padding-left:$_unit-padding*7; background-color: $color__teal-600; font-size: 12px;}
}
.folding-icon{
